...
namespace DersNotlari
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(yeni_metin);
            //Console.WriteLine("Girilen metindeki 'e' harfi sayısı: " + karakterSayac);
            //Console.ReadLine();
            ...
            /* konu tekrarı  ve örnek sınav soruları  çözümü   */

            /* bir sayı dizisi tanımla . Boyutu 10 olsun içerisine 1 - 100 arasındaki sayılardan rastgele ata .Sonra kullanıcıdan 1-100 arası sayı iste kullanıcının girdiği sayı dizi içerisinde var mı ? varsa kaçtane  var ? Ekrana bu bilgileri ekrana yazdır . */
            ...
            //int değer = Convert.ToInt32(Console.Read());
            //int sayac = 0; 
            //for (int i = 0; i < dizi.Length; i++)
            //{
            //    if (dizi[i] == değer )
            ...
            //if (sayac > 0)
            //{
            //    Console.WriteLine("Girdiğiniz değer , dizi içerisinde " + sayac + "tane var ");
            //}
            //else
            //{
            //    Console.WriteLine("girdiğiniz değer dizi içerisinde yoktur");
            //}
            //Console.Read();

            /*Bir sayı dizisi tanımla . Boyutu 15 olsun .İçerisine 100 - 200 arasındaki sayılardan rastgele ata . Sonra dizi içerisine 150 den büyük kaç tane eleman olduğunu bul ekrana yazdır . */
            ...
            //    }
            //}
            //Console.WriteLine("  Dizi içinde 150 den büyük sayılar   " + sayac + "   tane  vardır ");
            //Console.ReadLine();


            /*   10 elemanlı 3 tane tam sayı dizisi ; vize , final , ortalama  , vize  ve final diziileri içerisine 0 100 arasındaki sayıları ata.    */
            // vize notlarının  % 40 ını finalin % 60 ını alıp ortalamayı bul  ortalama dizisindeki 60 in altında kaç not olduğu bilgisini ekrana yazdırın 
            ...
            //{
            //    vize[i] = random.Next(1,101);
            //    final[i] = random.Next(1, 101);

            //}
            //foreach (int i in vize)
            //{
            //    Console.Write(i + " ");
            //}
            //Console.WriteLine();
            ...
            //    }
            //}
            //foreach (double i in ortalama)
            //{
            //    Console.Write(i + " ");
            //}

            //Console.WriteLine();
            //Console.Write("sınavdan 60 altı alan kişi " +  sayac);
            //Console.Read();

            // kullanıcıdan aldığımız kelimedeki  a harfinin sayisini bulan kodu yazınız 
            //int sayac = 0;
            //Console.WriteLine("kelime girin ");
            //string Kelime = Console.ReadLine();
            //char[] chars = Kelime.ToCharArray();
            ...
            //    }
            //}
            //Console.WriteLine("Girilen    " + Kelime + "    kelimesinin  içinde   " + sayac + "   Tane a vardır.");
            //Console.ReadKey();

            // kullanıcıdan bir cümle girmesini isteyiniz ve girilen cümlede kaç kelime olduğunu bulan C# kodunu yazınız

            //Console.WriteLine("kelime girin :  ");
            //string kelime = Console.ReadLine();
            //string[] kelime_sayisi = kelime.Split(' ');
            //Console.WriteLine(kelime + " cümlesindeki kelime sayısı: " + kelime_sayisi.Length);
            //Console.ReadLine();

            // kaç ve olduğunu  bulun . 
            int sayac = 0;
            Console.WriteLine("Kaç ve olduğunu bul ");
            string kelime = Console.ReadLine();
            string[] cümle = kelime.Split(' ');
            foreach (string i in cümle)
            {
                if( i == "ve")
                {
                    sayac++;
            ...
            Console.WriteLine(" bu kelimede bu kadar ve vardır:    " + sayac);
            Console.Read();
